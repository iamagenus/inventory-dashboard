...
function App() {
  ...
  const handleDeleteProduct = (productId) => {
    ...
    addToHistory(
      "delete",
      `Deleted product: ${product ? product.name : "Unknown"}`,
    );
  };
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-500">
            Overview of your current stock and value.
          </p>
        </div>
        ...
        {/* --- FIXED SECTION --- */}
        {/* Only render the modal when it is open. This ensures a clean state reset. */}
        {isModalOpen && (
          <AddProductModal
            isOpen={isModalOpen}
